package com.nao20010128nao.GateZenzyo.server.network.minecraftpe.protocol.raknet.protocol;
...
public class EncapsulatedPacket implements Cloneable {
	...
	public int getTotalLength() {
		return 3 + this.buffer.length + (this.messageIndex != null ? 3 : 0) + (this.orderIndex != null ? 4 : 0)
				+ (this.hasSplit ? 10 : 0);
	}
